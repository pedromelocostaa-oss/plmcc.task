...
import { MobileNav, MobileHeader } from "@/components/layout/MobileNav";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Caveat:wght@500;600;700&display=swap" },
    ],
  }),
    ...
    <>
      <div style={{
        ...
        <main style={{
          ...
          overflowX: "hidden",
          position: "relative",
          /* Room for mobile top header + bottom nav */
          paddingTop: isMobile ? "calc(52px + env(safe-area-inset-top, 0px))" : 0,
